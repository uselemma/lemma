...
meta:
  ...
  goal: "List the SDK attributes Analytics widgets consume"
  audience: "Engineers shipping usage, model, and latency telemetry"
---
...
| Vercel AI SDK | Extracts `usage` when present on finish/step-end events; AI SDK telemetry callbacks do not always include usage |
