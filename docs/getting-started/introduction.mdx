...
4. **Investigate** in the dashboard, [Inspect](/platform/inspect), Slack, Linear, or a coding agent. See [Turn a Lemma issue into a verified fix](/guides/turning-issues-into-fixes).
