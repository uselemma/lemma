...
## Diagnose traces that already land

Use the Lemma diagnostics skill when traces are already arriving and you want to know whether their shape matches the [high-quality traces guide](/guides/building-high-quality-traces). The skill does not edit your app. If nothing is landing, use the tracing skill instead.

```text
https://github.com/uselemma/lemma/tree/main/skills/lemma-diagnostics
```
