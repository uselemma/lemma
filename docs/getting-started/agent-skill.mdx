...
```text
Install the Lemma AI skill with the Vercel Skills CLI from github.com/uselemma/lemma at skills/lemma-tracing, then use it to add tracing to this application.
```
