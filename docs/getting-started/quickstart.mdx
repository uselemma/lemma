...
<Steps>
  <Step title="Optional: install the Lemma tracing skill">
    ...
    Then prompt your agent to use the Lemma tracing skill to add tracing to your application. After traces land, install `lemma-diagnostics` to audit their shape without editing your app.
  </Step>
