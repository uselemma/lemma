---
title: "Reference"
description: "Full reference for tools, resources, and prompts available on the MCP server"
---

This page documents everything exposed by the MCP server at `https://api.uselemma.ai/mcp`. See [MCP Server](/connections/mcp) for connection setup.
