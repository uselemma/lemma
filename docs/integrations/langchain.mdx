---
title: "LangChain"
description: "Lemma callback tracing for LangChain chains, models, and tools"
icon: "/images/brands/langchain.svg"
meta:
  contentType: "How-to"
  goal: "Record LangChain runs with Lemma callback handlers"
  audience: "Engineers on LangChain"
---
...
Promote identity from configurable metadata/tag keys (`threadIdKey` / `thread_id_key`, `userIdKey` / `user_id_key`). Defaults also check `conversation_id`, `session_id`, and `resourceId`.
