...
Install the tracing package alongside the AI SDK and Zod:
...
Each AI SDK event maps to a Lemma record:
...
AI SDK v7 reports model and tool durations directly. AI SDK v6 reports tool execution durations; model-call durations are inferred from start and finish timestamps when the AI SDK does not report an explicit duration.
