...
handler through the graph invoke config. A complete docs-chat agent using this
integration lives in [`examples/langgraph`](https://github.com/uselemma/lemma/tree/main/examples/langgraph)
(TypeScript) and [`examples/python/langgraph`](https://github.com/uselemma/lemma/tree/main/examples/python/langgraph)
...
recorded. Redact secrets and sensitive user data before they reach the graph.
