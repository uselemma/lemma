---
title: "Turning issues into fixes"
description: "Triage a production issue, inspect the evidence, ship a change, and confirm it does not recur"
meta:
  contentType: "How-to"
  goal: "Walk one production issue from evidence through a shipped fix and a recurrence check"
  audience: "People taking a Lemma issue to a code change"
---
...
## Triage, investigate, ship, and verify
