...
meta:
  contentType: "How-to"
  goal: "Keep OpenTelemetry and add Lemma SDK tracing beside it"
  audience: "Engineers with existing OpenTelemetry instrumentation"
---
...
<CardGroup cols={2}>
  ...
  <Card title="Integrations" href="/integrations/vercel-ai">
