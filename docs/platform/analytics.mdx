...
Analytics is feature-gated. If you don’t see **Analytics** in the project sidebar, it isn’t enabled for your workspace. The project **Dashboard** (home and setup) is a different page. Analytics is not a standalone metrics product.
